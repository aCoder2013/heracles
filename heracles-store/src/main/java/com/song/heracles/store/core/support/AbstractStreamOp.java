...
public abstract class AbstractStreamOp<Response extends StreamResponse> implements StreamOp {
    ...
    public void fail(Throwable throwable) {
        ...
        if (throwable instanceof OwnershipAcquireFailedException) {
            ...
            fail(ErrorCode.OWNER_ALREADY_EXIST,
                "There is already a owner exist :" + ownershipAcquireFailedException
                    .getCurrentOwner()
            ...
            fail(ErrorCode.getByCode(heraclesStorageException.getCode()),
                heraclesStorageException.getMessage());
    ...
    public abstract CompletableFuture<Response> doExecute(AsyncLogWriter asyncLogWriter,
