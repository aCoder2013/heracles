...
public class DefaultStreamFactory implements StreamFactory {
    ...
    public DefaultStreamFactory(String clientId, DistributedLogConfiguration dlConfig,
        Namespace namespace, OrderedExecutor orderedExecutor) {
    ...
    public Stream getOrOpenStream(String name) {
        ...
        synchronized (this) {
            stream = new DefaultStream(name, null, dlConfig, namespace, clientId, orderedExecutor,
                this);
