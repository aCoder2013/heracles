...
public class DlogTest {
    ...
    public void read() throws Exception {
        ...
        try {
            ...
            CompletableFuture<List<LogRecordWithDLSN>> completableFuture = asyncLogReader
                .readBulk(200, 2500, TimeUnit.MILLISECONDS);
            completableFuture.thenAccept(logRecordWithDLSNS -> {
                logRecordWithDLSNS.forEach(logRecordWithDLSN -> {
                    System.out.println(logRecordWithDLSN.getDlsn() + " -> " + new String(
