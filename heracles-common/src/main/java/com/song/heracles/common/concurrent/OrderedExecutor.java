package com.song.heracles.common.concurrent;
/**
...
public class OrderedExecutor implements ExecutorService {
    ...
    protected class TimedRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (elapsedMicroSec >= warnTimeMicroSec) {
                log.warn("Runnable {}:{} took too long {} micros to execute.", runnable,
                    runnable.getClass(),
                    elapsedMicroSec);
            }
        }
    ...
    protected OrderedExecutor(String baseName, int numThreads, ThreadFactory threadFactory,
        boolean traceTaskExecution, long warnTimeMicroSec, int maxTasksInQueue) {
    ...
    public long getThreadID(long orderingKey) {
        ...
        return threadIds[MathUtils.safeMod(orderingKey, threadIds.length)];
    }
    ...
    public ExecutorService chooseThread(Object orderingKey) {
        ...
        return threads[MathUtils.safeMod(orderingKey.hashCode(), threads.length)];
    }
    ...
    public ExecutorService chooseThread(long orderingKey) {
        ...
        return threads[MathUtils.safeMod(orderingKey, threads.length)];
    }
