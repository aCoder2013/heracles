...
public class ZkOffsetStorageTest {
    ...
    public void setUp() throws Exception {
        ...
        curatorFramework = CuratorFrameworkFactory
            .newClient("127.0.0.1:2182", new RetryNTimes(3, 1000));
    ...
    public void readOffsetFromStorage() throws Exception {
        ...
        assertThat(this.offsetStorage.readOffsetFromStorage(partitionedTopic).getDlsn())
            .isEqualTo(DLSN.InitialDLSN);

        this.offsetStorage.persistOffset(partitionedTopic);
        assertThat(this.offsetStorage.readOffsetFromStorage(partitionedTopic).getDlsn())
            .isEqualTo(new DLSN(1, 2, 3));
    }
