...
public class ZkDistributedIdGenerator implements DistributedIdGenerator {
    ...
    public ZkDistributedIdGenerator(CuratorFramework client, String counterPath, String prefix)
        throws Exception {
        this.prefix = prefix;
        ...
        log.info("Created ephemeral sequential node at {} -- Generator Id is {}-{}", createPath,
            prefix, instanceId);
    }
