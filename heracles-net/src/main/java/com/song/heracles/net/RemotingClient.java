    ...
    public HeraclesApiGrpc.HeraclesApiVertxStub createHeraclesClient() {
        ...
        synchronized (this) {
            ...
            for (String server : servers) {
                ...
                log.info("new name server is chosen. OLD: {} , NEW: {}. namesrvIndex = {}", address,
                    newAddress, serverIndex.get());
                ...
                try {
                    ...
                    log.error("Try to establish connection to " + server + " failed,try next one.",
                        e);
                }
            }
        }
