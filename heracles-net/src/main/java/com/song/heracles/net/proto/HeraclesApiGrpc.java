...
public final class HeraclesApiGrpc {
    ...
    private static <T> io.grpc.stub.StreamObserver<T> toObserver(
        final io.vertx.core.Handler<io.vertx.core.AsyncResult<T>> handler) {
    ...
    public static io.grpc.MethodDescriptor<com.song.heracles.net.proto.HeraclesProto.ProducerConnectRequest,
        ...
        if ((getHandleProducerConnectMethod = HeraclesApiGrpc.getHandleProducerConnectMethod)
            == null) {
                        ...
                        io.grpc.MethodDescriptor.<com.song.heracles.net.proto.HeraclesProto.ProducerConnectRequest, com.song.heracles.net.proto.HeraclesProto.ProducerResponse>newBuilder()
                            ...
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                com.song.heracles.net.proto.HeraclesProto.ProducerResponse
                                    .getDefaultInstance()))
                            .setSchemaDescriptor(
                                new HeraclesApiMethodDescriptorSupplier("handleProducerConnect"))
                            .build();
                }
            }
        }
    ...
    public static io.grpc.MethodDescriptor<com.song.heracles.net.proto.HeraclesProto.SendMessageRequest,
        ...
        if ((getHandleSendMessageMethod = HeraclesApiGrpc.getHandleSendMessageMethod) == null) {
            synchronized (HeraclesApiGrpc.class) {
                if ((getHandleSendMessageMethod = HeraclesApiGrpc.getHandleSendMessageMethod)
                    == null) {
                        ...
                        io.grpc.MethodDescriptor.<com.song.heracles.net.proto.HeraclesProto.SendMessageRequest, com.song.heracles.net.proto.HeraclesProto.SendMessageResponse>newBuilder()
                            ...
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                com.song.heracles.net.proto.HeraclesProto.SendMessageResponse
                                    .getDefaultInstance()))
                            .setSchemaDescriptor(
                                new HeraclesApiMethodDescriptorSupplier("handleSendMessage"))
                            .build();
                }
            }
        }
    ...
    public static io.grpc.MethodDescriptor<com.song.heracles.net.proto.HeraclesProto.ConsumerConnectRequest,
        ...
        if ((getHandleConsumerConnectMethod = HeraclesApiGrpc.getHandleConsumerConnectMethod)
            == null) {
            synchronized (HeraclesApiGrpc.class) {
                if ((getHandleConsumerConnectMethod = HeraclesApiGrpc.getHandleConsumerConnectMethod)
                    == null) {
                        ...
                        io.grpc.MethodDescriptor.<com.song.heracles.net.proto.HeraclesProto.ConsumerConnectRequest, com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse>newBuilder()
                            ...
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse
                                    .getDefaultInstance()))
                            .setSchemaDescriptor(
                                new HeraclesApiMethodDescriptorSupplier("handleConsumerConnect"))
                            .build();
                }
            }
        }
    ...
    public static io.grpc.MethodDescriptor<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageRequest,
        ...
        if ((getHandleConsumerPullMessageMethod = HeraclesApiGrpc.getHandleConsumerPullMessageMethod)
            == null) {
            synchronized (HeraclesApiGrpc.class) {
                if ((getHandleConsumerPullMessageMethod = HeraclesApiGrpc.getHandleConsumerPullMessageMethod)
                    == null) {
                    HeraclesApiGrpc.getHandleConsumerPullMessageMethod = getHandleConsumerPullMessageMethod =
                        io.grpc.MethodDescriptor.<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageRequest, com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse>newBuilder()
                            .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                            .setFullMethodName(generateFullMethodName(
                                "com.song.fastmq.broker.net.HeraclesApi",
                                "handleConsumerPullMessage"))
                            .setSampledToLocalTracing(true)
                            .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                            ...
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse
                                    .getDefaultInstance()))
                            .setSchemaDescriptor(new HeraclesApiMethodDescriptorSupplier(
                                "handleConsumerPullMessage"))
                            .build();
                }
            }
    ...
    public static io.grpc.MethodDescriptor<com.song.heracles.net.proto.HeraclesProto.PullOffsetRequest,
        ...
        if ((getHandlePullOffsetMethod = HeraclesApiGrpc.getHandlePullOffsetMethod) == null) {
            synchronized (HeraclesApiGrpc.class) {
                if ((getHandlePullOffsetMethod = HeraclesApiGrpc.getHandlePullOffsetMethod)
                    == null) {
                        ...
                        io.grpc.MethodDescriptor.<com.song.heracles.net.proto.HeraclesProto.PullOffsetRequest, com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse>newBuilder()
                            ...
                            .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse
                                    .getDefaultInstance()))
                            .setSchemaDescriptor(
                                new HeraclesApiMethodDescriptorSupplier("handlePullOffset"))
                            .build();
                }
            }
        }
    ...
    public static abstract class HeraclesApiImplBase implements io.grpc.BindableService {
        ...
        /**
         */
        public void handleProducerConnect(
        ...
        /**
         */
        public void handleConsumerConnect(
        ...
        /**
         */
        public void handleConsumerPullMessage(
    ...
    public static final class HeraclesApiStub extends io.grpc.stub.AbstractStub<HeraclesApiStub> {
        ...
        public void handleConsumerPullMessage(
            ...
            io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse> responseObserver) {
            asyncUnaryCall(
                getChannel().newCall(getHandleConsumerPullMessageMethod(), getCallOptions()),
    ...
    /**
     */
    public static final class HeraclesApiBlockingStub extends
        io.grpc.stub.AbstractStub<HeraclesApiBlockingStub> {
        ...
        /**
         */
        public com.song.heracles.net.proto.HeraclesProto.ProducerResponse handleProducerConnect(
            com.song.heracles.net.proto.HeraclesProto.ProducerConnectRequest request) {
        ...
        /**
         */
        public com.song.heracles.net.proto.HeraclesProto.SendMessageResponse handleSendMessage(
            com.song.heracles.net.proto.HeraclesProto.SendMessageRequest request) {
            return blockingUnaryCall(
        ...
        /**
         */
        public com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse handleConsumerConnect(
            com.song.heracles.net.proto.HeraclesProto.ConsumerConnectRequest request) {
            return blockingUnaryCall(
        ...
        /**
         */
        public com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse handleConsumerPullMessage(
            com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageRequest request) {
            return blockingUnaryCall(
        ...
        /**
         */
        public com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse handlePullOffset(
            com.song.heracles.net.proto.HeraclesProto.PullOffsetRequest request) {
            return blockingUnaryCall(
    ...
    /**
     */
    public static final class HeraclesApiFutureStub extends
        io.grpc.stub.AbstractStub<HeraclesApiFutureStub> {
    ...
    public static abstract class HeraclesApiVertxImplBase implements io.grpc.BindableService {
        ...
        public void handleProducerConnect(
            ...
            asyncUnimplementedUnaryCall(getHandleProducerConnectMethod(),
                HeraclesApiGrpc.toObserver(response.completer()));
        }
        ...
        public void handleSendMessage(
            ...
            asyncUnimplementedUnaryCall(getHandleSendMessageMethod(),
                HeraclesApiGrpc.toObserver(response.completer()));
        }
        ...
        public void handleConsumerConnect(
            ...
            asyncUnimplementedUnaryCall(getHandleConsumerConnectMethod(),
                HeraclesApiGrpc.toObserver(response.completer()));
        }
        ...
        public void handleConsumerPullMessage(
            ...
            asyncUnimplementedUnaryCall(getHandleConsumerPullMessageMethod(),
                HeraclesApiGrpc.toObserver(response.completer()));
        }
        ...
        public void handlePullOffset(
            ...
            asyncUnimplementedUnaryCall(getHandlePullOffsetMethod(),
                HeraclesApiGrpc.toObserver(response.completer()));
        }
    ...
    /**
     */
    public static final class HeraclesApiVertxStub extends
        io.grpc.stub.AbstractStub<HeraclesApiVertxStub> {
        ...
        public void handleProducerConnect(
            ...
            asyncUnaryCall(
                getChannel().newCall(getHandleProducerConnectMethod(), getCallOptions()), request,
                HeraclesApiGrpc.toObserver(response));
        }
        ...
        public void handleConsumerPullMessage(
            ...
            asyncUnaryCall(
                getChannel().newCall(getHandleConsumerPullMessageMethod(), getCallOptions()),
                request, HeraclesApiGrpc.toObserver(response));
        }
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_HANDLE_PRODUCER_CONNECT:
                    serviceImpl.handleProducerConnect(
                        (com.song.heracles.net.proto.HeraclesProto.ProducerConnectRequest) request,
                        (io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ProducerResponse>) responseObserver);
                    break;
                case METHODID_HANDLE_SEND_MESSAGE:
                    serviceImpl.handleSendMessage(
                        (com.song.heracles.net.proto.HeraclesProto.SendMessageRequest) request,
                        (io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.SendMessageResponse>) responseObserver);
                    break;
                case METHODID_HANDLE_CONSUMER_CONNECT:
                    serviceImpl.handleConsumerConnect(
                        (com.song.heracles.net.proto.HeraclesProto.ConsumerConnectRequest) request,
                        (io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse>) responseObserver);
                    break;
                case METHODID_HANDLE_CONSUMER_PULL_MESSAGE:
                    serviceImpl.handleConsumerPullMessage(
                        (com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageRequest) request,
                        (io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse>) responseObserver);
                    break;
                case METHODID_HANDLE_PULL_OFFSET:
                    serviceImpl.handlePullOffset(
                        (com.song.heracles.net.proto.HeraclesProto.PullOffsetRequest) request,
                        (io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse>) responseObserver);
                    break;
                default:
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_HANDLE_PRODUCER_CONNECT:
                    serviceImpl.handleProducerConnect(
                        (com.song.heracles.net.proto.HeraclesProto.ProducerConnectRequest) request,
                        (io.vertx.core.Future<com.song.heracles.net.proto.HeraclesProto.ProducerResponse>) io.vertx.core.Future.<com.song.heracles.net.proto.HeraclesProto.ProducerResponse>future()
                            .setHandler(ar -> {
                                if (ar.succeeded()) {
                                    ((io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ProducerResponse>) responseObserver)
                                        .onNext(ar.result());
                ...
                case METHODID_HANDLE_SEND_MESSAGE:
                    serviceImpl.handleSendMessage(
                        (com.song.heracles.net.proto.HeraclesProto.SendMessageRequest) request,
                        (io.vertx.core.Future<com.song.heracles.net.proto.HeraclesProto.SendMessageResponse>) io.vertx.core.Future.<com.song.heracles.net.proto.HeraclesProto.SendMessageResponse>future()
                            .setHandler(ar -> {
                                if (ar.succeeded()) {
                                    ((io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.SendMessageResponse>) responseObserver)
                                        .onNext(ar.result());
                ...
                case METHODID_HANDLE_CONSUMER_CONNECT:
                    serviceImpl.handleConsumerConnect(
                        (com.song.heracles.net.proto.HeraclesProto.ConsumerConnectRequest) request,
                        (io.vertx.core.Future<com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse>) io.vertx.core.Future.<com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse>future()
                            .setHandler(ar -> {
                                if (ar.succeeded()) {
                                    ((io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ConsumerConnectResponse>) responseObserver)
                                        .onNext(ar.result());
                ...
                case METHODID_HANDLE_CONSUMER_PULL_MESSAGE:
                    serviceImpl.handleConsumerPullMessage(
                        (com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageRequest) request,
                        (io.vertx.core.Future<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse>) io.vertx.core.Future.<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse>future()
                            .setHandler(ar -> {
                                if (ar.succeeded()) {
                                    ((io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.ConsumerPullMessageResponse>) responseObserver)
                                        .onNext(ar.result());
                ...
                case METHODID_HANDLE_PULL_OFFSET:
                    serviceImpl.handlePullOffset(
                        (com.song.heracles.net.proto.HeraclesProto.PullOffsetRequest) request,
                        (io.vertx.core.Future<com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse>) io.vertx.core.Future.<com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse>future()
                            .setHandler(ar -> {
                                if (ar.succeeded()) {
                                    ((io.grpc.stub.StreamObserver<com.song.heracles.net.proto.HeraclesProto.PullOffsetResponse>) responseObserver)
                                        .onNext(ar.result());
